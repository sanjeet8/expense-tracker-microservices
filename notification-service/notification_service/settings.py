...
SECRET_KEY = 'django-insecure-#=^5e1%r-#@9tjmor@voc-haayeegad$gl8=v8okvj+qkbrth+'
...
EMAIL_HOST_USER = "vsanjeet8@gmail.com"
EMAIL_HOST_PASSWORD = "jmwi wcwb slac moxj"  # Generate an App Password if using Gmail
